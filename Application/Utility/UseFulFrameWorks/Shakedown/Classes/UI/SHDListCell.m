...
- (void)_setup {
    ...
    self.label.font = [UIFont fontWithName:FONT_REGULAR size:15];
...
- (void)_showList {
    ...
    SHDListCellEditor *view = [[SHDListCellEditor alloc] initWithFrame:CGRectMake(0,64, superView.bounds.size.width, superView.bounds.size.height - 64) sourceButton:self.displayButton items:self.internalItems];
    view.delegate = self;
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        _numberLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 9, 30, 30)];
        _numberLabel.backgroundColor = [UIColor clearColor];
        _numberLabel.textColor = [UIColor whiteColor];
        _numberLabel.font = [UIFont fontWithName:FONT_SEMI_BOLD size:14];
        _numberLabel.textAlignment = UITextAlignmentRight;
        
        _textField = [[UITextField alloc] initWithFrame:CGRectMake(40, 9, 260, 30)];
        _textField.font = [UIFont fontWithName:FONT_REGULAR size:14];
