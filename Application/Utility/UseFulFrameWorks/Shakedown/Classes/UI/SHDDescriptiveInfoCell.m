...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        _keyLabel.font = [UIFont fontWithName:FONT_SEMI_BOLD size:13];
        ...
        _valueLabel = [[UILabel alloc] initWithFrame:CGRectMake(120, 3, 600 , 15)];
        _valueLabel.font = [UIFont fontWithName:FONT_REGULAR size:13];
