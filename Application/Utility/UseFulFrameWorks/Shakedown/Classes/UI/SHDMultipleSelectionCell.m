...
- (void)_showOptions {
    ...
    SHDMultipleSelectionOptionsView *view = [[SHDMultipleSelectionOptionsView alloc] initWithFrame:CGRectMake(0, 64, superView.bounds.size.width, superView.bounds.size.height - 64) sourceButton:self.displayButton options:self.options];
    view.delegate = self;
